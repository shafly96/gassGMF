...
<div class="row">
	...
	<div class="col-xs-12">
		...
		<div class="box box-primary">
          ...
          <div class="form-group">
                @if(isset($about->about_gass_gambar))
                    <img src="{{url('/')}}/images/about/gass/{{$about->about_gass_gambar}}" class="img-thumbnail" alt="Cinque Terre" style="border:none;" width="400" height="236">
                @else
              ...
              <br> <label for="media">Change Header Image</label> <a href="#" data-toggle="tooltip" data-placement="bottom" title="Leave this form empty if there are no changes">  <i class="fa fa-info-circle"></i></a>
                <input type="file" class="form-control" name="media" id="media" @if(empty($about->about_gass_gambar))required @endif>
								<p id="p1"></p>
          </div>
...
@include('admin.master.script')
    @if(isset($about->about_gass_text))
    <script type="text/javascript">
      $(document).ready(function () {
        $(".textarea").wysihtml5().html('{{$about->about_gass_text}}');
      });
      </script>
    @else
      <script>

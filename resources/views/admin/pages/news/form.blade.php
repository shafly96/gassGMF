...
<div class="row">
	...
	<div class="col-xs-12">
		...
		<div class="box box-primary">
			...
			<!-- form start -->
			<form role="form" method="post" action="{{url('/')}}/news/form" enctype="multipart/form-data">
				<div class="box-body">
          ...
          <div class="form-group">
                <label for="media">News Image</label> @if(isset($update))<a href="#" data-toggle="tooltip" data-placement="bottom" title="Leave this form empty if there are no changes">  <i class="fa fa-info-circle"></i></a>@endif

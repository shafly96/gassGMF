...
<div class="row">
	...
	<div class="col-xs-12">
		...
		<div class="box box-primary">
          ...
          <div class="form-group">
                <?php if(isset($about->about_gmf_gambar)): ?>
                    <img src="<?php echo e(url('/')); ?>/images/about/gmf/<?php echo e($about->about_gmf_gambar); ?>" class="img-thumbnail" alt="Cinque Terre" style="border:none;" width="400" height="236">
                <?php else: ?>
              ...
              <br> <label for="media">Change Header Image</label> <a href="#" data-toggle="tooltip" data-placement="bottom" title="Leave this form empty if there are no changes">  <i class="fa fa-info-circle"></i></a>
                <input type="file" class="form-control" name="media" id="media"                <?php if(empty($about->about_gmf_gambar)): ?>required <?php endif; ?>>
								<p id="p1"></p>
          </div>
...
<?php echo $__env->make('admin.master.script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php if(isset($about->about_gmf_text)): ?>
    <script type="text/javascript">
      $(document).ready(function () {
        $(".textarea").wysihtml5().html('<?php echo e($about->about_gmf_text); ?>');
      });
      </script>
    <?php else: ?>
      <script>

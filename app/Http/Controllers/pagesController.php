...
class pagesController extends Controller
{
  ...
  public function showhome(){
    ...
    $this->data['active2'] = "";
    $this->data['slides'] = Homepage::join('homepage_image','homepage.homepage_id','=','homepage_image.homepage_id')->get();

    return view('admin.pages.editor.homepage',$this->data);
  }
  ...
  public function showinsert(){
    ...
    $this->data['active'] = 'homepage';
    $this->data['active2'] = '';
    return view('admin/pages/editor/homepagebak',$this->data);
  }
  ...
  public function showupdate($id){
    ...
    $this->data['active'] = 'homepage';
    $this->data['active2'] = '';
    $this->data['homepage'] = DB::table('homepage')->join('homepage_image','homepage.homepage_id','=','homepage_image.homepage_id')->where('homepage.homepage_id', '=', $id)->first();
  //  dd($this->data['homepage']);
    return view('admin/pages/editor/homepagebak',$this->data);
  ...
  public function showcustomer(){
    ...
    return view('admin.pages.editor.tabelcustomer',$this->data);
  }
  public function addcustomer(){
    ...
    return view('admin.pages.editor.formcustomer',$this->data);
  }
  ...
  public function contacts(){
    ...
    $this->data['active2'] = "";
    $this->data['contacts']= Contacts::find(1);
    return view('admin.pages.editor.contactsform',$this->data);
  }
  ...
  public function showaboutgmf(){
    ...
    $this->data['active2'] = "gmf";
    $this->data['about'] = About::find(1);
    if(isset($this->data['about'])){
      $this->data['about']->about_gmf_text = str_replace("\r",'', $this->data['about']->about_gmf_text);
      $this->data['about']->about_gmf_text = str_replace("\n",'', $this->data['about']->about_gmf_text);
      $this->data['about']->about_gmf_text = str_replace("\r\n",'', $this->data['about']->about_gmf_text);
    }
    return view('admin.pages.editor.form-aboutgmf',$this->data);
  ...
  public function showaboutgass(){
    ...
    $this->data['active'] = "about";
    $this->data['active2'] = "gass";
    $this->data['about'] = About::find(1);
    if(isset($this->data['about'])){
      $this->data['about']->about_gass_text = str_replace("\r",'', $this->data['about']->about_gass_text);
      $this->data['about']->about_gass_text = str_replace("\n",'', $this->data['about']->about_gass_text);
      $this->data['about']->about_gass_text = str_replace("\r\n",'', $this->data['about']->about_gass_text);
    }
    return view('admin.pages.editor.form-aboutgass',$this->data);
  ...
  public function showaboutfac(){
    ...
    $this->data['active'] = "about";
    $this->data['active2'] = "facc";
    $this->data['about'] = About::find(1);
    if(isset($this->data['about'])){
      $this->data['about']->about_facility_text = str_replace("\r",'', $this->data['about']->about_facility_text);
      $this->data['about']->about_facility_text = str_replace("\n",'', $this->data['about']->about_facility_text);
      $this->data['about']->about_facility_text = str_replace("\r\n",'', $this->data['about']->about_facility_text);
    }
    return view('admin.pages.editor.form-ourfacility',$this->data);
  ...
  public function showtestimony(){
    ...
    $this->data['active'] = "about";
    $this->data['active2'] = "test";
    $this->data['about'] = About::find(1);
    return view('admin.pages.editor.form-testimony',$this->data);
  ...
  public function tabelmanager(){
    $this->checklogin();
    $this->data['active'] = "about";
    $this->data['active2'] = "manager";
    $this->data['manager'] = manager::get();
    return view('admin.pages.editor.tabel-manager',$this->data);
  }
  ...
  public function addmanager(){
    ...
    return view('admin.pages.editor.form-manager',$this->data);
  }
  ...
  public function updmanager($id){
    $this->data['manager'] = manager::find($id);
    $this->data['active'] = 'about';
    $this->data['active2'] = 'manager';
